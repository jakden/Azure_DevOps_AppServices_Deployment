...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG01.png)

Search for App Services and select the option in the dropdown list.  Select add to create a new App Service.

![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG03.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG04.png)
...
```
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG06.png)

Next you will want to upgrade Chocolately by running the command:
```Powershell
choco upgrade chocolatey
```
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG07.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG20.png)
...
git init
```
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG19.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG14.png)

![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG15.png)
```Powershell
git submodule add *your selected theme https link here*
```
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG17.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG21.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG24.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG26.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG32.png)

![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG33.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG34.png)

![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG35.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG45.png)

![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG47.png)

![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG48.png)

Your deployment may take a few minutes to complete but once it is live you will see the messages below.

![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG52.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG55.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG63.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG70.png)
...
![alt text](https://github.com/jakden/Azure_DevOps_AppServices_Deployment/blob/main/P0001_IMG82.png)
